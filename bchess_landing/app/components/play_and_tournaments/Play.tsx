            ...
            <div className="play_content">
                <div className="play_content_block">
                    <div className="play_content_text">
                        ...
                        <h2 className="play_sub_header">Currently, BChess.io offers peer-to-peer (P2P) gaming, allowing you to challenge friends or players from around the globe to a game of chess. Whether you are looking to have fun, improve your skills, or simply enjoy the game of kings in a modern format, BChess.io is the place for you.<br /><br />
                            Why Play on BChess.io? Decentralized Gaming: Experience chess on a platform where integrity and fairness are built into every move. Secure and Transparent: Thanks to the Blast.io blockchain, your games are secure, and every move is verifiable. Play Anytime, Anywhere: Challenge your friends or other players to a match, regardless of where you are in the world. Community and Competition: Join a growing community of chess enthusiasts and blockchain aficionados.</h2>
                    </div>
